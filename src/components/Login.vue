  ...
  methods: {
    ...
    async login() {
      ...
      this.$refs.loginFormRef.validate(async valid => {
        ...
        this.$store.dispatch('loginuser/setUsername',this.loginForm.user);
          // var res = await this.login(this.loginForm);
          // console.log(res);
        // const { data: res } = await this.$http.post('/crm/oauth/token', this.loginForm)
...
.login_box {
  ...
  background-image: url("../assets/images/tp1_dry2.png");
